...
//       const response = await putUser(email);
//       if(response.errorMessage){
//         toast.error(response.errorMessage)
//       }else{setResponse(response.message)}
      
//   };

//   return (
//     <>
//     {!response ? (<div className={styles.AddEmailContainer}>
//     <p>Add people to the board </p>
//     <input onChange={handleEmail} value={email} placeholder='Enter the email'/>
//     <div className={styles.button}><button onClick={()=>props.handleComponent('')} className={styles.btn2}>Cancel</button><button onClick={fetchPutUser} className={styles.btn1}>Add Email</button></div>
//     </div>):
//     (<div className={styles.EmailContainer}>
//         <p>{resonse}</p>
//         <button onClick={()=>props.handleComponent('')} className={styles.btn1}>Okay, got it!</button>
//     </div>)}
